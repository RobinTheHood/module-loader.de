    ...
    <body>
        <div class="container">
            ...
            <section id="create_structure">
                ...
                <img src="/images/tutorial_010.png" class="imagePreview">
                ...
                <img src="/images/tutorial_020.png" class="imagePreview">
            ...
            <section id="create_moduleinfo">
                ...
                <img src="/images/tutorial_030.png" class="imagePreview">
                ...
                <img src="/images/tutorial_040.png" class="imagePreview">
            ...
            <section id="create_system_files">
                ...
                <img src="/images/tutorial_050.png" class="imagePreview">
                ...
                <img src="/images/tutorial_060.png" class="imagePreview">
            ...
            <section id="install_module_at_shop">
                ...
                <img src="/images/tutorial_090.png" class="imagePreview">
            </section>
