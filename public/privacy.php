    ...
    <body>
        <div class="page-wrapper page-privacy">
            ...
            <div class="content">
                <main>
                    <section>
                        <h2>Datenschutz / Datenschutzerklärung</h2>
                        <p>Die nachfolgende Datenschutzerklärung gilt für die Nutzung der Webseite module-loader.de (nachfolgend „Website“).</p>
                        ...
                        <ul>
                            ...
                            <li>gemäß Artikel 22 Absätze 1 und 4 DSGVO und – zumindest in diesen Fällen – aussagekräftige Informationen über die involvierte Logik sowie die Tragweite und die angestrebten Auswirkungen einer derartigen Verarbeitung für Sie</li>
                        </ul>
                        ...
                        <p>Sie haben das Recht, von uns unverzüglich die Berichtigung Sie betreffender unrichtiger personenbezogener Daten zu verlangen. Unter Berücksichtigung der Zwecke haben Sie das Recht, die Vervollständigung unvollständiger personenbezogener Daten – auch mittels einer ergänzenden Erklärung – zu verlangen.

                        <h4>3.3 Recht auf Löschung („Recht auf Vergessenwerden“)</h4>

                        <p>Sie haben das Recht, von uns zu verlangen, dass Sie betreffende personenbezogene Daten unverzüglich gelöscht werden, und wir sind verpflichtet, personenbezogene Daten unverzüglich zu löschen, sofern einer der folgenden Gründe zutrifft:
                        ...
                        <ul>
                            ...
                            <li>wir die personenbezogenen Daten für die Zwecke der Verarbeitung nicht länger benötigen, Sie die Daten jedoch zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen benötigten</li>
                        ...
                        <h3>6 Weitergabe von Daten an Dritte, Keine Datenübertragung ins Nicht-EU-Ausland</h3>
                        ...
                        <p>Eine Datenübertragung an Stellen oder Personen außerhalb der EU findet nicht statt.</p>
                    </section>
                </main>
            </div>
