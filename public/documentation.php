...
<html lang="de" dir="ltr">
    ...
    <body>
                    ...
                    <article>
                        ...
                        <section>
                            ...
                            <ul>
                                ...
                                <li>modified eCommerce Shopsoftware <strong>2.0.3.0</strong> bis <strong>2.0.7.2</strong></li>
                        ...
                        <section>
                            ...
                            <div class="notice info">
                                <p><strong>Hinweis:</strong> In der folgenden Anleitung musst du <code class="nowrap">www.dein-shop.tld</code> durch deine Shop-Url ersetzen.</p>
                            </div>
        ...
        <div style="display: none" class="pageWrapper withSidebar">
            <aside class="sidebar">
                <nav>
                    <h3>Übersicht</h3>
                    <ul>
